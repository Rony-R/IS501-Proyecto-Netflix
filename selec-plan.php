  ...
  <body>
    ...
    <input type="text" class="form-control" id="input-pag"  value="1">
      <div class="pricing-header px-3 py-3 pt-md-5 pb-md-4 mx-auto text-center margin-sup">
        ...
        <h1 class="lead text-selecciona">Selecciona tu plan.</h1>
      </div>
      <div class="container">    
          <div class="row" >
              ...
              <div class="col-10 col-sm-8 col-md-4">
                  <div class="row">
                      <div class="col-1 col-sm-1 padding-span-texto" >
                          <i class="fas fa-check red"></i>
                      </div>
                      <div class="col-11 col-sm-10 padding-span-texto" >
                          <span>No se te cobrará hasta que termine tu mes gratis.</span>
                      </div>
                  ...
                  <div class="row">
                      ...
                      <div class="col-11 col-sm-10 padding-span-texto" >
                          <span>Te recordaremos 3 días antes de que termine tu prueba.</span>
                      </div>
                      <div class="col-1 col-sm-1">   
                      </div>
                  </div>
      ...
      <div class="pricing-header px-3 py-3 pt-md-5 pb-md-4 mx-auto text-center">
         <div class="row">
            ...
            <div class="col-10 col-sm-8 col-md-6">
                <button type="button" class="btn btn-danger" id="btn-ver">VER LOS PLANES</button> 
            </div>
