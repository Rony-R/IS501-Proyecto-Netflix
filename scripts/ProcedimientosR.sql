...
BEGIN
    ...
    INSERT INTO TBL_REGISTRO_TARJETA (CODIGO_REG_TARJETA, CODIGO_USUARIO, CODIGO_TIPO_TARJETA, NOMBRE_USUARIO, APELLIDO_USUARIO, NUMERO_DE_TARJETA, CODIGO_DE_SEGURIDAD, FECHA_VENCIMIENTO) VALUES (SEQ_COD_REGIS_TARJ.NEXTVAL, SEQ_COD_USUARIO.CURRVAL, P_COD_TIPO_TARJ, P_NOMBRE, P_APELLIDO, P_NUMERO_TARJ, P_SEGURIDAD, P_VENCIMIENTO);
    COMMIT;
...
--Ejecucion:
CALL P_INSERTAR_TARJETA (1, 'Pepa', 'Pig', '2193823721', '112233', TO_DATE('2019-05-01', 'YYYY-MM-DD'));
...
BEGIN
    INSERT INTO TBL_PELICULAS (CODIGO_PELICULA, CODIGO_UNIDAD, DURACION_PELI) VALUES (SEQ_COD_CONTENIDO.CURRVAL, P_CODIGO_UNIDAD, P_DURACION);
    COMMIT;
...
BEGIN
    ...
    INSERT INTO TBL_EPISODIOS (CODIGO_EPISODIO, CODIGO_TEMPORADA, CODIGO_UNIDAD_DURACION, DURACION_EPISODIO, NOMBRE_EPISODIO, NUMERO_EPISODIO, DESCRIPCION_EPISODIO) VALUES (SEQ_COD_EPISODIO.NEXTVAL, SEQ_COD_REG_TEMPORADA.CURRVAL, P_COD_UNIDAD_DURACION, P_DURACION, P_NOMBRE, P_NUMERO_EP, P_DESCRIPCION);
    COMMIT;
