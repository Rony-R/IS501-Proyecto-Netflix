...
INSERT INTO TBL_COLORES (CODIGO_COLOR, NOMBRE_COLOR, NUMERO_HEXADECIMAL, CODIGO_RGB) VALUES (1, 'transparente', 'transparent','(0,0,0,0)');
INSERT INTO TBL_COLORES (CODIGO_COLOR, NOMBRE_COLOR, NUMERO_HEXADECIMAL, CODIGO_RGB) VALUES (2, 'Blanco', '#FFF','(255,255,255)');
INSERT INTO TBL_COLORES (CODIGO_COLOR, NOMBRE_COLOR, NUMERO_HEXADECIMAL, CODIGO_RGB) VALUES (3, 'Negro', '#000','(0,0,0)');
INSERT INTO TBL_COLORES (CODIGO_COLOR, NOMBRE_COLOR, NUMERO_HEXADECIMAL, CODIGO_RGB) VALUES (4, 'Rojo', '#c80000','(200,0,0)');
INSERT INTO TBL_COLORES (CODIGO_COLOR, NOMBRE_COLOR, NUMERO_HEXADECIMAL, CODIGO_RGB) VALUES (5, 'Verde', '#00c800','(0,200,0)');
INSERT INTO TBL_COLORES (CODIGO_COLOR, NOMBRE_COLOR, NUMERO_HEXADECIMAL, CODIGO_RGB) VALUES (6, 'Azul', '#0000c8','(0,0,200)');
INSERT INTO TBL_COLORES (CODIGO_COLOR, NOMBRE_COLOR, NUMERO_HEXADECIMAL, CODIGO_RGB) VALUES (7, 'Amarillo', '#eedc00','(238,220,0)');
INSERT INTO TBL_COLORES (CODIGO_COLOR, NOMBRE_COLOR, NUMERO_HEXADECIMAL, CODIGO_RGB) VALUES (8, 'Magenta', '#d60080','(214,0,128)');
INSERT INTO TBL_COLORES (CODIGO_COLOR, NOMBRE_COLOR, NUMERO_HEXADECIMAL, CODIGO_RGB) VALUES (9, 'Azul turquesa', '#009fda','(0,159,218)');
...
INSERT INTO TBL_ESTILOS_SUBTITULOS (CODIGO_ESTILO_SUB, CODIGO_TIPO_FUENTE, CODIGO_SOMBRA, CODIGO_COLOR_FUENTE, CODIGO_COLOR_SOMBRA, CODIGO_COLOR_FONDO, CODIGO_COLOR_VENTANA, TAMANIO_FUENTE) VALUES(0, 1, 1, 7, 2, 3, 1, 'Normal');
