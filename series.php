          ...
          <section class="seccion1">
           <img id="portada-series" src="img/series/umbrella/3.jpg" style="width:100%; height:800px; position:absolute"> 
               <div class="descripcion1">
                              ...
                              <div class="dropdown">
                                 ...
                                 <div class="container">
                                   <div class="row">
                                        ...
                                        <div class="col-lg-4">
                                             <li><a id="menu2" href="#">Acción</a></li>
                                        </div>

                                        <div class="col-lg-4">
                                             <li><a id="menu2" href="#">Romance</a></li>
                                        </div>

                                        <div>
                                             <li><a id="menu2" href="#">Infantiles</a></li>
                                        </div>
                    ...
                    <br>
                    <div>
                         <h4 style="color:white;margin:0">ORIGINAL DE <b>NETFLIX</b></h4>
