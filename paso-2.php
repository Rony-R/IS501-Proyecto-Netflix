...
<html lang="en">
  <head>
    ...
    <link href="css/registro-cuenta-1.css" rel="stylesheet">
  ...
  <body>
    ...
    <input type="text" class="form-control" id="input-pag"  value="3">
   <div id="body">
    <div class="pricing-header px-3 py-3 pt-md-5 pb-md-4 mx-auto text-center margin-sup">
      <div id="div-img-dispositivo" ><img id="img-dispositivos" src="img/img-dispositivos.png"></div>
      <span class="lead text-paso">PASO <span class="bold-txt">2</span> DE <span class="bold-txt">3</span></span>
      <h1 class="lead text-selecciona">Crea tu cuenta.</h1>
    </div>
    <div class="container">    
        <div class="row" >
            <div class="col-1 col-sm-2 col-md-4"></div>
            <div class="col-10 col-sm-8 col-md-4 text-center text">
                  <span>Usa tu email y crea una contraseña para ver Netflix en cualquier dispositivo, cuando quieras.</span>
                <div class="row">
    ...
    <div class="pricing-header px-3 py-3 pt-md-5 pb-md-4 mx-auto text-center">
      <div class="row">
         ...
         <div class="col-10 col-sm-8 col-md-6">
             <button type="button" class="btn btn-danger" id="btn-continuar">CONTINUAR</button> 
         </div>
         <div class="col-1 col-sm-2 col-sm-3"></div>
      </div>   
   </div>
   </div>
